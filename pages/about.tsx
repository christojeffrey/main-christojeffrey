      ...
      <div className={` bg-neutral-100 text-neutral-900 min-h-screen`}>
        ...
        <main className={`pt-8 centerx `}>
          ...
          <div className="md:text-base text-sm w-3/4 md:w-1/2">
            ...
            semester. He is dying for purpose in this absurd universe. In the meantime, school keeps him busy. you can reach him by email at <TextClickCopy>contact@christojeffrey.com</TextClickCopy>
          </div>
